    ...
    items: [
      {
        ...
        body: "Mehmonxona ish yuritadigan barcha shaxs va tashkilotlar bazasi. Olti xil profil turi bor: Mehmon (xonada turadigan jismoniy shaxs), Kompaniya, Turagent (komissiya foizi \"Agentliklar\" sahifasida beriladi), Manba (bronlar qayerdan kelayotgani), Guruh va Kontakt (tashkilotdagi aniq odam). \"Qidirish\" bo'limida ism, aloqa (telefon yoki email), hujjat raqami, fuqarolik va profil turi bo'yicha qidirasiz — to'ldirilgan har bir maydon ro'yxatni toraytiradi. Fuqarolik yonidagi lupani bossangiz davlatlar ro'yxati ochiladi. Maydonlarni to'ldirib \"Qidirish\" tugmasini bosing (yoki Enter), butun ro'yxatga qaytish uchun \"Tozalash\". Yangi profil \"Parametrlar\" tugmasi orqali ochiladi: avval turi tanlanadi, keyin shu turga mos forma chiqadi (mehmonda hujjat va fuqarolik, tashkilotda STIR va manzil). Sodiqlik darajasi (Bronza/Kumush/Oltin/Platina) faqat Mehmon turida bo'ladi. Bir odam uchun ikkita profil ochilgan bo'lsa, \"Parametrlar\" > \"Dublikat profillarni birlashtirish\" orqali ularni birlashtiring — turlari bir xil bo'lishi shart.",
      },
      {
        key: 'loyalty',
