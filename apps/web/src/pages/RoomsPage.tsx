...
const STATUS_STYLES: Record<RoomStatus, string> = {
  ...
  // "Band" holati brend navy'da (2026-09-04) — avval oddiy `blue` edi, u
  // brend palitrasida yo'q va ilovaning qolgan ko'k rangidan farq qilardi.
  occupied: 'bg-brand-navy-light text-brand-navy border-brand-navy/25',
