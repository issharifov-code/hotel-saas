// ISO 3166-1 alpha-2 davlat kodlari va o'zbekcha nomlari.
//
// Bu ro'yxat GENERATSIYA QILINGAN (Node `Intl.DisplayNames(['uz'])` orqali,
// 2026-09-04) va qo'lda tahrirlanmaydi — nomlar CLDR ma'lumotlaridan olingan.
// Ish vaqtida `Intl` ishlatilmaydi: brauzerlar o'zbek tilini har xil qo'llab
// quvvatlaydi, statik ro'yxat esa hamma joyda bir xil chiqadi.
//
// Nomlar bo'yicha (o'zbekcha alifbo tartibida) saralangan holda saqlanadi —
// ro'yxat aynan shu tartibda ko'rsatiladi.
...
export const COUNTRIES: Country[] = [
  ...
  { code: 'EH', name: "G‘arbiy Sahroi Kabir" },
...
// Kod bo'yicha tez qidirish (masalan profilda saqlangan "UZ" ni nomga
// aylantirish uchun).
